return {
  ...
  opts = function(_, opts) -- override the options using lazy.nvim
    ...
    opts.section.buttons.val = {
      opts.button("fn", "  new file", ":enew <BAR> startinsert <CR>"),
      ...
      opts.button("fk", "  Password Manager", ":e $HOME/Atd/GhiChu/docs/web/atd_pm.norg<CR>"),
      ...
      opts.button("v", "▶️ Youtuber", ":cd $HOME/Atd/vh3m | Telescope oldfiles<CR>"),
